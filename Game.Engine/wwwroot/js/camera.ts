...
export class Camera {
    ...
    updateViewport() {
        ...
        this.viewport.rectangle =new PIXI.Rectangle(this.lookat[0] - this.distance * Math.tan(this.fieldOfView) / 2.0,this.lookat[1] - this.distance * Math.tan(this.fieldOfView) / this.aspectRatio / 2.0, this.distance * Math.tan(this.fieldOfView),this.distance * Math.tan(this.fieldOfView) / this.aspectRatio);
